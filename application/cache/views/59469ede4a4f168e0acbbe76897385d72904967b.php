				...
				<div class="row">
					<div class="col-lg-8">
						...
						<div class="box">
							<div class="row">
								<div class="col-lg-8">
									<span class="num_ref">ref.: <?php echo $imovel->cod_imovel; ?></span>
					...
					<div class="col-lg-4">
						...
						<?php if($imovel->creci != ''): ?>
							...
							<div class="captador">
								...
								<?php if($imovel->telefone2 != ''): ?>
									<a href="https://api.whatsapp.com/send?phone=55<?php echo e(str_replace(['(', ')', '-', ' '], '', $imovel->telefone2)); ?>"
										class="btn btn-success btn-sm mt-2" 
										target="_blank">
										<i class="fab fa-whatsapp"></i> Envia uma mensagem
									</a>
								<?php endif; ?>
							</div>
						<?php endif; ?>
