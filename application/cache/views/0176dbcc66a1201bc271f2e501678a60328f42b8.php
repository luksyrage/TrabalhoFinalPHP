        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <ul class="nav nav-contato justify-content-end">                   
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://api.whatsapp.com/send?phone=5514997129244" target="_blank"><i class="fab fa-whatsapp"></i> (14)99712-9244</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)"><i class="fas fa-envelope"></i> prime@primeimobiliaria.com.br</a>
                    </li>
                </ul>
            </div>
        </div>
