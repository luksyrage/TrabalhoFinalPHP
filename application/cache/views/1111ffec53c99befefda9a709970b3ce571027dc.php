        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-contato justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-phone"></i> (14) 3227-0052</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-phone"></i> (14)99792-7000</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-envelope"></i> imoveis@grizoni.com.br</a>
                    </li>
                </ul>
            </div>
        </div>
