<div class="box filtro-lateral">
	<form id="imoveis-busca">		
		<div class="tabs">
			<!-- ABA 1 -->
		    <input type="radio" name="negocio"  value="V" class="aba" id="tab1" <?php echo e($filtro['negocio'] == 'comprar' ? 'checked' : ''); ?>>
		    <label for="tab1">Comprar</label>
		    
		    <!-- ABA 2 -->
		    <input type="radio" name="negocio" value="L" class="aba" id="tab2" <?php echo e($filtro['negocio'] == 'alugar' ? 'checked' : ''); ?>>
