<div>
    <div class="container"> 
        <div class="row">
            <div class="col-lg-2 align-self-center">CRECI 92.682</div>
            <div class="col-lg-10">
                <ul class="nav nav-contato justify-content-end">                   
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)"><i class="fas fa-phone"></i> (14) 3245-0000</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://api.whatsapp.com/send?phone=5514997927000" target="_blank"><i class="fab fa-whatsapp"></i> (14)99999-9999</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)"><i class="fas fa-envelope"></i> contato@primeimobiliariabauru.com.br</a>
                    </li>
                </ul>
            </div>
        </div>
